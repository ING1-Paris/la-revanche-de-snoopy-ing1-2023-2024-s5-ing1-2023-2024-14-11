...
void counter(int h, int *resultat) {
    Color(5, 0);
    char touche = ' ';
    while (touche != 'w' && touche != 'q' && touche != 'd' && touche != 'z' && touche != 's' && mort[2] != 1) {
        if (touche != 'p') {
            ...
            case 3:
                ...
                switch (niveauchoisi[0]) {
                    case 'a':
                        ...
                        printf("\t - Q pour aller a gauche \n");
                        printf("\t - W pour sauvegarder la partie \n");
                        printf("\t - M pour stoper la partie \n");
                        Color(15, 0);
                        ...
                        do {
                            ...
                            Color(15, 0);
                            if (touche == 'w') {
                                printf("Inscrire le nom du fichier : \n");
                                scanf("%s", nomfichier);
                                strcat(nomficentier, "./");
                                strcat(nomfichier, ".txt");
                                strcat(nomficentier, nomfichier);
                                ...
                                if (touche == 'q' || touche == 'd' || touche == 'z' || touche == 's' || resultat[1] != xb) {
                                    xb = resultat[1];
                                    for (int i = 1; i < 11; i++) {
                                        strcpy(jeu[i], ligne1);
                                        jeu[i][0] = '|';
                                ...
                                if (total == 4) {
                                    ...
                                    score1 = (2 * 60 - minute * 60 - second) * 100;
                                    score += score1;
                                    printf("Pour le niveau 1 vous avez obtenu %d points", score1);
                                    touche ='m';
                                }
